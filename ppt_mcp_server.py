...
app = FastMCP(
    ...
    instructions=(
        ...
        "Build every slide first, then run validate_presentation for "
        "structural faults and call visual_repair_slides once on the whole "
        "deck for appearance; they check different things. The repair tool "
        "inspects before it fixes, so do not call visual_inspect_slides "
        "ahead of it. Deliver the deck with "
